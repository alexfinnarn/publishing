...
headTitle: "Tooling for 1,000+ sites — Alex Finnarn"
...
<CaseMeta items={[
  { k: 'Scale', v: '1,000+ sites · 50+ repositories' },
  { k: 'Stack', v: 'Drupal, Vue, Vagrant → Docker' },
  { k: 'Focus', v: 'CI and developer environment' },
]} />
...
<div class="next-prev">
  <Link href="/problems/#floor">← A team that cannot reproduce its own bugs</Link>
  <Link href="/cases/va-publishing/">First case study →</Link>
</div>
