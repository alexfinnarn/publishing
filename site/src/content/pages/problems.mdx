...
import CareerBlob from '../../components/CareerBlob';
...
<CaseList items={[{ title: 'Splitting a giving platform from its CMS', href: '/cases/cu-giving/', context: 'University of Colorado · 2020–2022' }]} />
...
<CaseList items={[{ title: 'Accelerated publishing at the VA', href: '/cases/va-publishing/', context: 'CivicActions · 2022–2024' }]} />
...
<CaseList items={[{ title: 'Tooling for 1,000+ sites', href: '/cases/cu-tooling/', context: 'University of Colorado · 2015–2019' }]} />
...
export const chronology = [
  { when: '2022–2024', where: 'CivicActions', role: 'Senior Backend Drupal Engineer',
    what: 'Federal content platforms for the VA and CMS. Decoupled publishing, ~15 Drupal sites, Migrate API work, Ionic/Angular mobile, Cypress/Jenkins, accessibility (edX certificate). Speaker at three regional conferences on test automation and frontend.' },
  { when: '2020–2022', where: 'University of Colorado', role: 'online giving platform',
    what: '~$5.4M/year. Led the domain-driven migration separating content management from payment processing. Kanban, Theory of Constraints, Architectural Decision Records.' },
  { when: '2015–2019', where: 'University of Colorado', role: 'platform and tooling',
    what: 'Vue UI to 1,000+ sites. CI across 50+ repositories. Shared local environments (Vagrant, then Docker).' },
  { when: '2019', where: 'Highlights for Children',
    what: 'Drupal 7 family of sites; start of the Drupal 8 platform.' },
  { when: '2014–2015', where: 'Coplex', role: 'contractor to maintenance team lead',
    what: '15–20 clients. Sold follow-on performance and SEO packages.' },
  { when: '2013–2014', where: 'Sogeti', role: 'Ethicon (Johnson & Johnson)',
    what: 'Drupal 7 multisite; coordinated an offshore team of four.' },
  { when: '2009', where: 'Ohio State University',
    what: 'BS, Psychology. More relevant to content modeling than it sounds.' },
];

<Chronology entries={chronology} />

<p><Link class="more" href="/contact/">Recognize one of these? →</Link></p>
