...
4. Close the issue. Do not keep an ever-growing archive of open discovery
...
For an assistant (or for later-you):

- Read the last closed or open discovery issue and the files it links.
- Ask from the last reply: what was opened, what was left hanging.
- Prefer a line of questions over instructions and negative constraints.
- Link only what is needed while answering.
- Use the project's language (`Impression`, `Lesson`, `Problem set`, etc.).
